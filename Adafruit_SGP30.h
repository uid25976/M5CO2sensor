 ...
 * 
 * 2025-07-14 : aprocha46 : I2C communication methods now virtual + private -> protected
 * You need to override thses methods in your derived class to adapt to your I2C driver
 */
...
protected:
  ...
  virtual bool readWordFromCommand(uint8_t command[], uint8_t commandLength,
