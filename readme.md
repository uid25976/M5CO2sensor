...
It displays the last 50 measurements which translates into 5 minutes of records. This allows you to check if the measurements were stabilized (see above).
